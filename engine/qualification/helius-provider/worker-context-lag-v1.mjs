// Explicit qualification-only context-lag successor, not the zero-retry entry.
import { readFileSync, closeSync } from 'node:fs';
import { pathToFileURL } from 'node:url';
import { admitQualificationInputV1 } from './qualification-contract-v1.mjs';
import { createSession, loadExchange, put, LIMITS, VERSION, RETRY_POLICY } from './bounded-context-lag-v1.mjs';
