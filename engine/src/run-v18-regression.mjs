...
console.log('Trade Artifact v1.8 Regression Runner');
console.log('Deterministic local suites only. No live Helius, upload, mint, signing, browser automation, mutable-cache pipeline tests, remote deploy, or network calls.');
