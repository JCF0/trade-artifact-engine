...
test('v1.15 provider checklist and operations drafts pin every release-blocking compatibility assumption', () => {
  ...
  for (const required of [
    ...
    'signatures-only mode costs 1 credit per request', 'full mode costs 100 credits per request',
    'getTransaction` costs 1 credit per request',
    '100 credits plus 1 credit for each exact fallback request',
