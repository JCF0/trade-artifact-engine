...
console.log('Trade Artifact v1.7 Regression Runner');
console.log('Deterministic local suites only. No live Helius, upload, mint, signing, browser automation, remote deploy, or network calls.');
