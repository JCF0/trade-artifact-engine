...
const tx = { tx_hash: providerSignature('tx'), slot: 42, block_time: 1700000000 };
...
const finding = {
  ...
  affected_token_mints: [providerPublicKey('mint')], affected_quote_mints: [], source_transaction_digests: [d],
...
const mark = {
  ...
  mark_observation_digest: d, token_mint: providerPublicKey('mint'), quote_mint: providerPublicKey('quote'), observation_status: 'available',
...
const blocked = {
  ...
  blocked_summary_digest: d, chain: 'solana', network: 'mainnet-beta', wallet: providerPublicKey('wallet'), token_mint: providerPublicKey('mint'),
