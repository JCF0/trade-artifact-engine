...
import { buildEventRecordV1 } from './identity.mjs';
...
const limited = projectionFor([raw({ token: 'LIMITED', timestamp: 600, tx: 'sell-limited', index: 0, buy: false, base: 3, quote: 9 })], 'LIMITED');
