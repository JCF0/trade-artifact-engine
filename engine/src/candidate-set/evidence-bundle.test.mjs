...
const acquisitionResult = buildWalletAcquisitionResultV1({ acquisition_result_version: 'wallet_wide_acquisition_result_v1', scope, profiles, boundary, input_status: inputStatus, coverage: recomputeCoverageV1(coverageArgs), transaction_dispositions: [disposition], normalized_event_records: [event], activity_findings: [] });
const markInput = { token_mint: 'TOKEN', quote_mint: 'QUOTE', observation_status: 'available', source_profile: 'direct_quote_mark_v1', mark_price_raw_quote: 2, observed_at: 950, source_slot: 95, reason_code: null };
