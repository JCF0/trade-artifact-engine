...
const txInput = { tx_hash: providerSignature('tx'), slot: 7, block_time: null }; const tx = buildSourceTransactionReferenceV1(txInput); txInput.slot = 99; assert.equal(tx.slot, 7); assert.ok(Object.isFrozen(tx));
const markInput = { token_mint: providerPublicKey('mint'), quote_mint: providerPublicKey('quote'), observation_status: 'unavailable', source_profile: 'direct_quote_mark_v1', mark_price_raw_quote: null, observed_at: null, source_slot: null, reason_code: 'mark_source_unavailable' };
