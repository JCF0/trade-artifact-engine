...
assert.deepEqual(canonical.map(item => item.token_mint), ['TOKEN', 'ZZZ']);
...
assert.throws(() => validateMarkObservationsV1([laterEvidence], { markProfile: 'direct_quote_mark_v1', anchorSlot: 10, anchorBlockTime: 100 }), error => error.code === 'mark_observation_invalid');
