...
export function validateProductionWigglesConfigurationV1(configuration, now) {
  ...
  assertLiveReadyBoundedAgentMandateV1(input.mandate); // Strict final-proof wallet/profile.
  ...
  for (const field of ['setup_archive_sha256', 'setup_freeze_sha256', 'setup_evidence_manifest_sha256']) {
